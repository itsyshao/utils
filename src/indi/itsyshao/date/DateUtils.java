...
public class DateUtils {
	 ...
	 * @return Date
	 */
	public Date getMonthDayOfYear(int offset, int month_offset, int day_offset) {
		cal.setTime(this.fiducialDate);
		cal.set(Calendar.YEAR, cal.get(Calendar.YEAR) + offset);
		cal.set(Calendar.MONTH, Calendar.JANUARY);
		cal.set(Calendar.DAY_OF_MONTH, 1);
	 ...
	 * @return Date
	 */
	public Date getMonthDayOfQuarter(int offset, int Month_offset, int day_offset) {
		cal.setTime(this.fiducialDate);
		cal.add(Calendar.MONTH, offset * 3);
		int mon = cal.get(Calendar.MONTH);
		if (mon >= Calendar.JANUARY && mon <= Calendar.MARCH) {
		...
		cal.add(Calendar.MONTH, Month_offset - 1);
		cal.add(Calendar.DAY_OF_MONTH, day_offset - 1);
		return cal.getTime();
	}
	 ...
	 * @return
	 */
	public Date getDateOfMonth(int offset, int dateth) {
		cal.setTime(this.fiducialDate);
		cal.add(Calendar.MONTH, offset);
		cal.set(Calendar.DAY_OF_MONTH, 1);
		cal.add(Calendar.DAY_OF_MONTH, dateth - 1);
		return cal.getTime();
	}
	 ...
	 * @return Date
	 */
	public Date getDayOfWeek(int offset, int day) {
		cal.setTime(this.fiducialDate);
		cal.add(Calendar.DAY_OF_MONTH, offset * 7);
		cal.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
